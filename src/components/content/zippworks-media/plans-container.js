...
export default function Content() {
  ...
  return (
    <div className="mx-auto border-standard p-4 bg-neutral-200 rounded-4xl flex flex-row gap-8 max-w-7xl items-stretch max-lg:flex-col">
        ...
        >
          <div className="flex flex-col gap-8 w-full">
            <div className="flex flex-row items-center justify-between">
              ...
              {plan.badge && <p className="tag white small ">{plan.badge}</p>}
            </div>
